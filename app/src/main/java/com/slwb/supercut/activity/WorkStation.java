package com.slwb.supercut.activity;
...
import com.slwb.util.ImageUtil;
...
//屏幕的宽度,高度
        ...
        if (outFileSrc != null) {
            ...
            width = parse.parseString2Int(retriever.extractMetadata(android.media.MediaMetadataRetriever.METADATA_KEY_VIDEO_WIDTH));
            height = parse.parseString2Int(retriever.extractMetadata(android.media.MediaMetadataRetriever.METADATA_KEY_VIDEO_HEIGHT));
